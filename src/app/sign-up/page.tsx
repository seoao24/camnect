...
export default function SignUp() {
	...
	const register = async () => {
		...
		try {
			...
			formData.append('role', form.role.toString());

			// Gửi request sử dụng FormData
			await axiosInstance.post('/Authentication/SignUp', formData, {
				headers: {
				...
				<div className='p-10 bg-[#F07202] rounded-tl-[20px] rounded-bl-[20px] rounded-br-[20px] max-w-[740px]'>
					<div className='grid grid-cols-2 gap-4'>
						<input
							...
							className='bg-white outline-none border-none p-4'
					...
					<div className='flex text-white py-4'>
						...
						<div className='flex ml-5'>
							...
							/>
							<label htmlFor='photographer' className='ml-2'>
