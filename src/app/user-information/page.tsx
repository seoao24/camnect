            ...
            <div className="mt-5">
                <div className='w-full md:h-[500px] bg-cover bg-center bg-no-repeat md:py-10 py-5 flex justify-center items-center'
                    ...
                    <div>
                        ...
                        <div className="md:text-[36px] text-[14px] text-[#F07202] font-bold text-center">{form?.fullname}</div>
                ...
                <div className="container">
                    <div className="flex justify-between items-center">
                        <button
                            ...
                            <div className='text-[24px] text-white ml-2'>Cật nhật thông tin</div>
                        </button>
                        <Link
                            href={"/user"}
                    ...
                    <div className='mt-5'>
                        <div className="grid grid-cols-2 gap-4">
                            <input
                                type="text"
                                className='px-2 py-1 border-[1px] border-[#F07202] rounded-[5px] outline-none' placeholder='Email' readOnly value={'camnect@yopmail.com'} />
                            <input
                                type="text"
                                name='numberPhone'
                                onChange={handleChange}
                                value={form?.numberPhone}
                                className='px-2 py-1 border-[1px] border-[#F07202] rounded-[5px] outline-none' placeholder='Số điện thoại' />
                        </div>
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <input
                                ...
                                value={form?.fullname}
                                name='fullname'
                                className='px-2 py-1 border-[1px] border-[#F07202] rounded-[5px] outline-none' placeholder='Họ tên' />
                            <input
                                type="password"
                                name='password'
                                onChange={handleChange}
                                value={form?.password}
                                readOnly
                                className='px-2 py-1 border-[1px] border-[#F07202] rounded-[5px] outline-none' placeholder='Mật khẩu' />
                        </div>
                        <div
                            className="mt-4">
                            <textarea
                        ...
                        </div>
                        {
                            form?.role == 1 ? (
                                <div className='flex justify-center mt-4'>
                                    ...
                                    />
                                    <label htmlFor="qrUrl">
                                        <div className="w-[300px] h-[300px] bg-center bg-cover bg-no-repeat border-[1px] rounded-[5px] border-[#F07202] flex justify-center items-center" style={{
