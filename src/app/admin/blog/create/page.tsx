...
export default function AddBlog() {
	...
	const addBlog = async () => {
		...
		if (!image) {
			toast.error('Vui lòng thêm ảnh tiêu đề');
			return;
		}
		...
		try {
			...
			toast.error('Lỗi khi thêm blog, vui lòng kiểm tra lại');
		}
	};
	...
	return (
		<div>
			<div className='flex justify-between items-center mb-5'>
				...
				<button onClick={addBlog} className='rounded-[5px] text-white bg-[#FF9900] px-4 py-2'>
					Thêm blog
				</button>
			</div>
			<div>
			...
			<div className='my-4'>
				...
				{imageUrl && (
					<div
						className='w-[300px] h-[300px] bg-cover bg-center bg-no-repeat rounded-[5px] mt-4 relative'
						style={{
