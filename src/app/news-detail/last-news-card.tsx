...
export default function LastNewsCard(props: LastNewsCardProps) {
	return (
		<Link href={'/news-detail?id=' + props.id} className='flex my-3'>
			<div
				className='w-[400px] h-[230px] bg-cover bg-no-repeat bg-center bg-[#D9D9D9]'
				style={{
			...
			<div className='text-black px-5'>
				...
				<div className='md:text-[20px] text-[12px] font-[500] truncate md:max-w-[800px] overflow-hidden line-clamp-4'>
					{props.content}
				</div>
			</div>
		</Link>
